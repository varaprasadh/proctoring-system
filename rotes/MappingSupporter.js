...
Router.get("/getStudents/:payload",(req,res)=>{
    ...
    console.log(payload);
    [aux,department,section]=payload;
    var sql=null;
    var cols =`regdNo,name,year,section,department`;
    var sql=`select ${cols} from students where (name like %'${aux}'% or regdNo='${aux}') and department='${department} and section='${section}' `;
